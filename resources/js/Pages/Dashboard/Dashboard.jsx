            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div className="p-6 text-gray-900 dark:text-gray-100 flex gap-4">
                            {albums && albums.length > 0 ? (
                                albums.map((album) => (
                                    <div key={album.id} className="cursor-pointer group relative flex flex-col my-6 dark:bg-gray-600 bg-white shadow-sm border border-gray-400 rounded-lg w-96 hover:shadow-lg transition-shadow duration-300">
